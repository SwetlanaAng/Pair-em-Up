export default class ElementCreator {
  ...
  createElement(parameters) {
    ...
    if (parameters.attributesNames) this.setAttributes(parameters.attributesNames);
    if (parameters.textContent) this.setTextContent(parameters.textContent);
    if (parameters.callback) this.setCallback(parameters.callback, parameters.eventName);
  }
